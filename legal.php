		<div class="legal popup">
			...
			<div class="legal content">
				...
				<p>This website contains links to other websites, some of which are not under the control of eustasy. As such, we have no control over the nature, content &amp; availability of those sites. The inclusion of any links does not necessarily imply a recommendation or endorse the views expressed within them.</p>
				<p>Every effort is made to keep the website up &amp; running smoothly. However, eustasy takes no responsibility for, &amp; will not be liable for, the website being temporarily unavailable due to technical issues beyond our control.</p>
				<h3>Privacy Policy</h3>
				<p>This privacy policy sets out how eustasy uses &amp; protects any information that you give eustasy when you use our websites.</p>
				<p>eustasy is committed to ensuring that your privacy is protected. Should we ask you to provide certain information by which you can be identified when using our websites, then you can be assured that it will only be used in accordance with this privacy statement.</p>
				<p>eustasy may change this policy from time to time by updating this page. You should check this page from time to time to ensure that you are happy with any changes. This policy is effective from 17/08/2013.</p>
				<h4>Promise</h4>
				...
				<h4>Security</h4>
				<p>We are committed to ensuring that your information is secure. In order to prevent unauthorised access or disclosure, we have put in place suitable physical, electronic &amp; managerial procedures to safeguard &amp; secure the information we collect online.</p>
				<h4>Links</h4>
				...
				<h3>Cookie Policy</h3>
				<p>This website uses Cookies to store only settings which you manually set. These Cookies are required for the usage of these settings.</p>
				<p>No third-party cookies are set at this time.</p>
				<h3>Terms of Service</h3>
				<p>If you continue to browse &amp; use this website, you are agreeing to comply with &amp; be bound by the following Terms &amp; Conditions of use, which together with our Privacy Policy govern eustasy's relationship with you in relation to this website. If you disagree with any part of these terms &amp; conditions, please do not use our website.</p>
				<ul>
					<li>The term 'eustasy' or 'us' or 'we' refers to the owner of the website.</li>
				...
				<ul>
					...
					<li>We have no responsibility for the content of the linked websites. We do not endorse the websites.</li>
